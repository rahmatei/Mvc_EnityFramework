...
namespace MVCEntityFrameWork.Migrations
{
    ...
    [Migration("20200603104246_update book model add field")]
    partial class updatebookmodeladdfield
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCEntityFrameWork.Models.Book_Category", b =>
                {
                    b.Property<int>("BookID");
            ...
            modelBuilder.Entity("MVCEntityFrameWork.Models.Book_Translator", b =>
                {
                    b.Property<int>("BookID");
            ...
            modelBuilder.Entity("MVCEntityFrameWork.Models.Publisher", b =>
                {
                    b.Property<int>("PublisherID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MVCEntityFrameWork.Models.Translator", b =>
                {
                    b.Property<int>("TranslatorID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MVCEntityFrameWork.Models.Book", b =>
                {
                    ...
                    b.HasOne("MVCEntityFrameWork.Models.Publisher", "publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("MVCEntityFrameWork.Models.Book_Translator", b =>
                {
                    b.HasOne("MVCEntityFrameWork.Models.Book", "Book")
                        .WithMany("Book_Translator")
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MVCEntityFrameWork.Models.Translator", "Translator")
                        .WithMany("Book_Translator")
